...
import CategoryHead from '@/views/products/listCategory/CategoryHead';
import CategoryFilter from '@/views/products/listCategory/CategoryFilter';
import CustomListTable from '@/components/custom-components/CustomListTable';
import { useCategoryListHandlers } from '@/handlers/products/category/useCategoryListHandlersVendorStyle';
import { getCategoryColumns } from './categoryColumns';
import { addCategory, updateCategory } from '@/app/(dashboard)/products/actions';
import AddCategoryDialog from '@/views/products/addCategory/AddCategoryDialog';
import EditCategoryDialog from '@/views/products/editCategory/EditCategoryDialog';

/**
 * CategoryList Component - Following vendors design pattern exactly
 */
const CategoryList = ({ initialCategories, initialPagination }) => {
  ...
  const handlers = useCategoryListHandlers({
    ...
    onView: handleOpenEditDialog, // Categories don't have view, use edit
