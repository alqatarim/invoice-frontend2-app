...
import useAddPurchaseHandlers from '@/handlers/purchases/addPurchase/useAddPurchaseHandlers';
...
const AddPurchase = ({ vendorsData, productData, taxRates, initialBanks, signatures, onSave, enqueueSnackbar, closeSnackbar, purchaseNumber }) => {
     ...
     // Wrap handleFormSubmit to ensure purchaseNumber is included
     ...
     const columns = getAddPurchaseColumns({
          control,
          errors,
          fields,
          watchItems,
