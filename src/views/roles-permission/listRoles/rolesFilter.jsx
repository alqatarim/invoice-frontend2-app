...
const RolesFilter = ({
  ...
  const applyFilters = () => {
    const currentFilterValues = {
      roleName: localFilters.roleName,
  ...
  const activeFilterCount = useMemo(() => {
    let count = 0
    if (localFilters.roleName.length > 0) count++
  ...
  // Mock role name options - you can replace this with actual data
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <MultiSelectDropdown
                  ...
                  onChange={handleSelectChange('roleName')}
