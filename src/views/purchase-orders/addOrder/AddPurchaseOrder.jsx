...
import useAddPurchaseOrderHandlers from '@/handlers/purchaseOrders/addPurchaseOrder/useAddPurchaseOrderHandlers';
...
const AddPurchaseOrder = ({ vendorsData, productData, taxRates, initialBanks, signatures, onSave, enqueueSnackbar, closeSnackbar, purchaseOrderNumber }) => {
  ...
  // Wrap handleFormSubmit to ensure purchaseOrderNumber is included
  ...
  const columns = getAddPurchaseOrderColumns({
    control,
    errors,
    fields,
    watchItems,
