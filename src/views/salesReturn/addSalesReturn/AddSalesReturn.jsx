...
const AddSalesReturn = ({ customersData, productData, taxRates, initialBanks, signatures, onSave, enqueueSnackbar, closeSnackbar, salesReturnNumber }) => {
  ...
  const handlers = useAddSalesReturnHandlers({
    salesReturnNumber,
    productData,
    initialBanks,
    signatures,
  ...
  // Wrap handleFormSubmit to ensure salesReturnNumber is included
  const handleFormSubmit = (data) => {
    if (!data.salesReturnNumber) {
      data.salesReturnNumber = salesReturnNumber;
    }
  ...
  const columns = getAddSalesReturnColumns({
    theme,
    control,
    errors,
    fields,
