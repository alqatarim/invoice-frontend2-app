...
import useSalesReturnHandlers from '@/handlers/salesReturn/useSalesReturnHandlers';
...
const EditSalesReturn = (props) => {
     ...
     // Use composing hook for all handlers and state
     const {
          control,
          handleSubmit,
          setValue,
     ...
     const columns = getEditSalesReturnColumns({
          theme,
          control,
          errors,
          fields,
     ...
     const emptyContent = (
          <Box className="flex flex-col items-center justify-center py-6 gap-2 text-center">
               ...
               <Typography variant="body2" color="text.secondary" sx={{ maxWidth: '300px' }}>
                    Click the 'Add Item' button to add items to your sales return
               </Typography>
               <Button
                    variant="outlined"
                    color="primary"
     ...
     return (
          <Grid container rowSpacing={4} columnSpacing={3}>
               ...
               {/* Top Section - Sales Return Details*/}
               <Grid size={{ xs: 12, md: 12 }}>
                    <Card>
                         <CardContent className='py-3.5'>
                              <Grid container columnSpacing={3} rowSpacing={4} >
                                   {/* Sales Return Details Header */}
                                        ...
                                        <Controller
                                             ...
                                             render={({ field }) => (
                                                  <TextField
                                                       ...
                                                       inputProps={{
                                                            min: formatDateForInput(getValues('salesReturnDate')),
                                                       }}
                                                  />
                                             )}
                                        />
                                   ...
                                   <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} className="flex flex-row gap-1 justify-between">
                                        ...
                                        >
                                             <Icon icon="mdi:bank-plus" width={22} />
                                        </CustomIconButton>
                                   </Grid>
