...
const QuotationListContent = ({ initialData, customers }) => {
...
const QuotationListContainer = ({ initialData, customers }) => {
  ...
  return (
    ...
    >
      <QuotationListContent initialData={initialData} customers={customers} />
    </SnackbarProvider>
  );
};
