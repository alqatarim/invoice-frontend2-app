...
/**
 * Calculate purchase totals with rounding option
 * Matches invoice totals signature for consistency
 * @param {Array} items - Array of purchase items
 ...
 */
export function calculatePurchaseInvoiceTotals(items, shouldRoundOff) {
